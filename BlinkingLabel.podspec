...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ftdjsxo/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ftdjsxo' => 'francescothiery94@gmail.com' }
  s.source           = { :git => 'https://github.com/ftdjsxo/BlinkingLabel.git', :tag => s.version.to_s }
